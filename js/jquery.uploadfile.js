	   ...
	   this.startUpload = function () {
		...
		function noserializeAndUploadFiles(s, obj, files) {
		    var ts = s;
                ...
                var form = $("<form style='display:block; position:absolute;left: 150px;' class='hide " + obj.formGroup + "' method='" + s.method + "' action='" + s.url + "' enctype='" + s.enctype + "'></form>");
                form.appendTo('body');
        ...
        function createCustomInputFile (obj, group, s, uploadLabel) {
            ...
            var form = $("<form class='hide' method='" + s.method + "' action='" + s.url + "' enctype='" + s.enctype + "'></form>");
