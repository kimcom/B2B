...
//		console.log(img.width, img.height, screen.height, $(window).height(), img.width/img.height, $(window).width()/$(window).height());
			minw = Math.min(img.width, screen.width, $(window).width());
			minh = Math.min(img.height, screen.height, $(window).height());
			minw = $(window).width();
			minh = $(window).height();
		...
		function stretchImage(img, aspectRatio) {
			...
			if (aspectRatio < wndWidth / wndHeight) {
				...
				style.left = '0px';
			//console.log("1", wndWidth, wndHeight, aspectRatio , wndWidth / wndHeight, img.width, screen.width, $(window).width());
			}
			else {
				...
				style.top = '0px';
			//console.log("2", wndWidth, wndHeight, aspectRatio, wndWidth / wndHeight, img.height, screen.height, $(window).height());
			}
		}
