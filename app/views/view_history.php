			...
			<div class="bs-docs-section m10" style="margin-bottom:0;">
				...
				<div class="bs-callout bs-callout-info text-left ml20">
					...
					<ul class='list-unstyled m0 mt5'>
						<li class='m0'>
							<ul>
								<li>1. имя файла только латиницей</li>
								<li>2. названия колонок не нужно указывать в первой строке</li>
								<li>3. формат строки: "Код товара", "Артикул", "Название", Цена, Кол-во</li>
								<li>4. разделитель дробной части "."</li>
							</ul>
						</li>
					</ul>
					<h4>Пример:</h4>
